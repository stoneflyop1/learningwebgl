...
function main() {
    ...
    gl.clearColor(0,0,0,1); // must clear color
    gl.enable(gl.BLEND);
...
function draw(gl, n, u_ViewMatrix, viewMatrix) {
    ...
    gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT); // 清除canvas
    gl.drawArrays(gl.TRIANGLES, 0, n);
}
...
function initVertexBuffers(gl, program) {
    const verticesColors = new Float32Array([
        ...
        -0.5, -0.5, -0.4,  0.4, 1.0, 0.4, 0.4,
         ...
         0.5,  0.4, -0.2,  1.0, 0.4, 0.4, 0.4, //黄色中间
        -0.5,  0.4, -0.2,  1.0, 1.0, 0.4, 0.4,
         0.0, -0.6, -0.2,  1.0, 1.0, 0.4, 0.4,

         0.0,  0.5,  0.0,  0.4, 0.4, 1.0, 0.4, //蓝色最前
